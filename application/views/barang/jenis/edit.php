                ...
                <div class="card shadow-sm border-bottom-primary">
                    <div class="card-header bg-white py-3">
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <a href="<?= base_url() ?>jenis/jenis_barang" class="btn btn-sm btn-secondary btn-icon-split">
                                    <span class="icon">
                        ...
                        <form action="<?= base_url() ?>jenis/proses_edit" method="post">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <input value="<?= $jenis->nama_jenis ?>" name="nama_jenis" id="nama_jenis" type="text" class="form-control" placeholder="Nama Jenis...">
                                </div>
                            </div>
                            <div class="row form-group">
