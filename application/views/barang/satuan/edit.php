        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card shadow-sm border-bottom-primary">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url() ?>satuan/proses_edit" method="post">
                            <div class="row form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <input value="<?= $satuan->nama_satuan ?>" name="nama_satuan" id="nama_satuan" type="text" class="form-control" placeholder="Nama Satuan...">
                                </div>
                            </div>
                            <div class="row form-group">
